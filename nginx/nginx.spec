...
%define COMMON_CONFIGURE_ARGS $(echo "\
        ...
        --with-file-aio \
        --with-ipv6 \
        --add-module=%{bdir}/ngx_http_substitutions_filter_module-%{ngx_http_substitutions_filter_module_commit} \
        --add-module=%{bdir}/ngx_http_google_filter_module-%{ngx_http_google_filter_module_commit} \
